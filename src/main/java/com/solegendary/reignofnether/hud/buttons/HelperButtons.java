...
public class HelperButtons {
    ...
    public static final Button chatButton = new Button(
            ...
            null,
            List.of(FormattedCharSequence.forward(Component.translatable("button.reignofnether.chat").getString(), Style.EMPTY))
    );
    ...
    public static final Button idleWorkerButton = new Button(
            ...
            null,
            List.of(FormattedCharSequence.forward(Component.translatable("button.reignofnether.idle_workers").getString(), Style.EMPTY))
    );
    ...
    public static final Button buildingCancelButton = new Button(
            ...
            null,
            List.of(FormattedCharSequence.forward(Component.translatable("button.reignofnether.cancel").getString(), Style.EMPTY))
    );
    ...
    public static final Button armyButton = new Button(
            ...
            null,
            List.of(FormattedCharSequence.forward(Component.translatable("button.reignofnether.select_all_military").getString(), Style.EMPTY))
    );
}
