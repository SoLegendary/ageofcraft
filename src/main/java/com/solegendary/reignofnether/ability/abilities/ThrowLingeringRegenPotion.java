...
public class ThrowLingeringRegenPotion extends Ability {
    ...
    public AbilityButton getButton(Keybinding hotkey) {
        return new AbilityButton(
            ...
            null,
            List.of(
                    FormattedCharSequence.forward(Component.translatable("ability.reignofnether.lingering_regen_potion").getString(), Style.EMPTY.withBold(true)),
                    FormattedCharSequence.forward("\uE007  3  " + "\uE004  " + CD_MAX_SECONDS + "s  \uE005  " + witchUnit.getPotionThrowRange(), MyRenderer.iconStyle),
                    FormattedCharSequence.forward(Component.translatable("ability.reignofnether.lingering_regen_potion.description").getString(), Style.EMPTY)
            ),
            this
        );
    }
