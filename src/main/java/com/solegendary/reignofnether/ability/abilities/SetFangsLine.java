...
public class SetFangsLine extends Ability {
    ...
    public AbilityButton getButton(Keybinding hotkey) {
        return new AbilityButton(
            ...
            null,
            List.of(
                    FormattedCharSequence.forward(Component.translatable("ability.reignofnether.evoker_fangs_line").getString(), Style.EMPTY.withBold(true)),
                    ...
                    FormattedCharSequence.forward(Component.translatable("ability.reignofnether.evoker_fangs_line.description1").getString(), Style.EMPTY),
                    FormattedCharSequence.forward(Component.translatable("ability.reignofnether.evoker_fangs_line.description2").getString(), Style.EMPTY)
            ),
            this
        );
    }
