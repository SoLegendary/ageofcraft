        ...
        return new AbilityButton(
                ...
                List.of(
                        FormattedCharSequence.forward(
                                Component.translatable("building.reignofnether.blacksmith.name").getString(),
                                Style.EMPTY.withBold(true)
                        ),
                        ResourceCosts.getFormattedCost(cost),
                        FormattedCharSequence.forward("", Style.EMPTY),
                        FormattedCharSequence.forward(
                                Component.translatable("building.reignofnether.blacksmith.description1").getString(),
                                Style.EMPTY
                        ),
                        FormattedCharSequence.forward("", Style.EMPTY),
                        FormattedCharSequence.forward(
                                Component.translatable("building.reignofnether.blacksmith.requirement").getString(),
                                Style.EMPTY
                        )
                ),
                null
